...
def make_composite_gif(data, range_geo, smooth=False):
    ...
    top = fig.add_gridspec(1, 7, wspace=0.20, left=0.06, right=0.985, top=0.96, bottom=0.8165)
    maps = fig.add_gridspec(1, 2, wspace=0.10, left=0.06, right=0.985, top=0.739, bottom=0.165)
    bot = fig.add_gridspec(1, 7, wspace=0.20, left=0.06, right=0.985, top=0.1735, bottom=0.03)
    ...
    fig.text(0.022, 0.888, "(a) Intersection interaction", rotation=90,
             ha="center", va="center", fontsize=12, fontweight="bold")
    fig.text(0.022, 0.102, "(b) Proximity interaction", rotation=90,
             ha="center", va="center", fontsize=12, fontweight="bold")
